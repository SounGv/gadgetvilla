// ============================================================
// GADGET VILLA — Tailwind Preset (shared)
// ใช้ร่วมกันทุก app: import ใน tailwind.config.ts ของ apps/web
// สีอ้างอิงจาก CSS variables ใน packages/ui/styles/tokens.css
// ============================================================
...
const preset: Partial<Config> = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['"LINE Seed Sans TH"', '"Noto Sans Thai"', 'Inter', 'system-ui', 'sans-serif'],
      },
      fontSize: {
